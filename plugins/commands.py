...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UPDATE ⚡', url='https://t.me/MGREBORN')
            ],
            [
                InlineKeyboardButton('⚡ JOIN CHANNEL ⚡', url=f"https://t.me/MGREBORN"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ JOIN CHANNEL ⚡', url='https://t.me/MGREBORN'),
            InlineKeyboardButton('🤖 UPDΛTES 🤖', url='https://t.me/MGREBORN')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('JOIN CHANNEL', url='https://t.me/MGREBORN') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
