...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://telegram.me/how_to_open_links_02/20')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⚡ JOIN CHANNEL ⚡', url='https://telegram.me/MGREBORN'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://telegram.me/MGREBORN')
        ], [
